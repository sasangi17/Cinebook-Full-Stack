    ...
    <div id='dateSelect' className='pt-30'>
        ...
        <div>
            ...
            <div className='flex items-center gap-6 text-sm mt-5'>
                ...
                <button onClick={onBookHandler} className='ml-auto bg-primary text-white px-8 py-2 rounded hover:bg-primary/90 transition-all cursor-pointer'>Book Now</button>
